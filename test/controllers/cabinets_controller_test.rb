...
class CabinetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cabinet" do
    assert_difference('Cabinet.count') do
      post cabinets_url, params: { cabinet: { address: @cabinet.address, name: @cabinet.name } }
    end
  ...
  test "should update cabinet" do
    patch cabinet_url(@cabinet), params: { cabinet: { address: @cabinet.address, name: @cabinet.name } }
